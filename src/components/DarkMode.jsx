  ...
  return (
    <div className="flex flex-col items-center justify-center gap-2">
      <div
        ...
        className={`w-14 h-8 lg:w-16 lg:h-9 flex items-center border border-gray-600 bg-white dark:dark-gradient-panels rounded-full p-1 cursor-pointer transition-colors duration-300 ${
