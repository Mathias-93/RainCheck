...
export default function WeatherConditionsCard({ children, title, icon }) {
  return (
    <div className="relative flex flex-col border border-gray-600 p-2 md:p-3 2xl:p-5 mt-2 w-full h-52 darker-blue rounded-2xl dark:bg-gradient-to-br dark:from-[#505050] dark:to-[#303030] dark:text-slate-200 text-gray-600 shadow-lg">
